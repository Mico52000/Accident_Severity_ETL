...
def load_operation(df_final, look_up_table,df_final_name,look_up_table_name):
    look_up_table.to_csv(look_up_table_name,index=False)
    df_final.to_csv(df_final_name,index=False)

def clean_and_transform(file_name,df_final_name,look_up_table_name):
    if os.path.isfile(df_final_name) and os.path.isfile(look_up_table_name):
        print("The lookup table and clean_transformed file already exist and are saved as csv.")
    else:
        ...
        load_operation(df_final, look_up_table,df_final_name,look_up_table_name)